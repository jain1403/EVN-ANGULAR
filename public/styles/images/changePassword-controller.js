...
analyticApp.controller('ChangePasswordCtrl', ['$scope', '$rootScope', 'changePwdService','$state',
	function($scope, $rootScope, changePwdService, $state) {
	...
	$scope.changePasswordSubmit = function(){
		...
		changePwdService.changePwd($scope.userdata).then(function(responceData){
